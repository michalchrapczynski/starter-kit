...
public class BookRestServiceTest {
	...
	//
	// Mockito.when(bookService.findBooksByTitle(bookTitle)).thenReturn(Arrays.asList(bookTo1,
	// bookTo2));
	//
	// // when
	// ResultActions response =
	// this.mockMvc.perform(get("/books-by-title?titlePrefix=" + bookTitle)
	...
	// // given
	// File file =
	// FileUtils.getFileFromClasspath("classpath:pl/spring/demo/web/json/bookToSave.json");
	...
	// // when
	// ResultActions response =
	// this.mockMvc.perform(delete("/book").accept(MediaType.APPLICATION_JSON)
